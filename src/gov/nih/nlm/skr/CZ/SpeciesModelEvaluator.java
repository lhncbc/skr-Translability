 ...
 *
 */
public class SpeciesModelEvaluator {
	private static Logger log = Logger.getLogger(SpeciesModelEvaluator.class.getName());	
	...
	public static void printDiffs(PrintWriter pw, Map<Class,List<String>> typeMap, 
		...
		for (String id : idList) {
			...
			for (Annotation a: allIdAnnotations) {
				if (idFPs.contains(a)) pw.write("[Output] " + a.getDocId() + "#" + a.getId() + "\t" + a.toResolvedString() + "\n");
				else if (idFNs.contains(a)) pw.write("    [GS] " + a.getDocId() + "#" + a.getId() + "\t" + a.toResolvedString() + "\n");
			}
			pw.write("\n");
		}
		pw.write("\n");
	...
	public static void main(String[] args) throws IOException {
		...
		map.put(TermAnnotation.class, Arrays.asList("OverallResult"));
...
//			if (id.equals("10091630") == false) continue;
