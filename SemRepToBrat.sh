...
java -Xmx10G -Xms10G -Djava.library.path=CRF/.libs -cp ${CP} gov.nih.nlm.skr.CZ.Brat   pubmed1950test/semrep/test.semrep pubmed1950test/normed/test.txt  pubmed1950test/brat setup.txt
